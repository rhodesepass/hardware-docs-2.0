...
## 项目声明
具体请见：[项目声明](./guide/project_statement.md)。 TL；DR：

::: warning 
本项目开源，遵守 CERN-OHL-P（硬件）/GPLv3（软件） 即可随意使用、修改、分发与售卖。项目与资料按原样提供；作者不参与商业、不获利、不提供维护/支持，也不对任何使用后果负责。

提建议/功能需求请走 Issue/PR： https://github.com/rhodesepass/electric_pass/issues

复刻/售卖必须醒目标注“第三方复刻、与原作者无关、问题由制作者负责”，自行售后，并自行承担许可证、IP、合规与安全等全部风险；不得宣传是“白银作品”
:::
